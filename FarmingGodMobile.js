  ...
  const msg = {
    nl_NL: {
      ...
      options: {
        ...
        newbarbs: 'Voeg nieuwe barbarendorden toe om te farmen:',
        button: 'Plan farms',
      },
      table: {
        noFarmsPlanned:
    ...
    hu_HU: {
      ...
      options: {
        ...
        warning:
          '<b>Figyelem:</b><br>- Bizonyosodj meg róla, hogy az "A" sablon az alapértelmezett és a "B" egy nagyobb mennyiségű mikro-farm<br>- Bizonyosodj meg róla, hogy a farm-filterek megfelelően vannak beállítva mielőtt használod a sctiptet',
        filterImage:
...
window.FarmGod.Main = (function (Library, Translation) {
  ...
  const bindEventHandlers = function () {
    ...
    // —— MOBILE “hold-to-send” button logic —— 
    ...
    $('#farmGod_send_all')
      ...
      .off('touchend mouseup touchcancel mouseleave')
      .on('touchend mouseup touchcancel mouseleave', () => {
